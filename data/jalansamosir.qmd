...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" description="" format="" name="File Geodatabase Feature Class" type="Local Area Network" mimeType="" size=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial dimensions="2" miny="0" minz="0" maxx="0" maxy="0" minx="0" crs="EPSG:4326" maxz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
